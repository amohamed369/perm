...
export async function generateStaticParams() {
  return getPostSlugs("resources").map((slug) => ({ slug }));
}
...
export default async function ResourcePage({ params }: PageProps) {
  ...
  const related = getRelatedPosts({ slug, type: "resources", meta: post.meta });

  return (
    <>
      <StructuredData type="resources" slug={slug} meta={post.meta} />
      <ArticleLayout meta={post.meta} type="resources" slug={slug} related={related}>
        <MDXRemote
          source={post.content}
