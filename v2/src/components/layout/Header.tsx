...
import { ChevronDown, Settings, LogOut, FileText, Loader2 } from "lucide-react";
            ...
            {AUTHENTICATED_NAV_LINKS.map((link) => {
              ...
              return (
                <NavLink
                  ...
                  className={cn(
                    "hover-underline px-3 sm:px-4 py-2 text-base sm:text-sm font-semibold font-heading uppercase tracking-wide transition-colors",
                    isActive
                      ? "text-primary"
